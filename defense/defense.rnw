...
\def\hik{\ds\frac{\suml{j}{1}{i-1}\lambda(j,i)z_{j,k}}
...
<<fig=T,echo=F,height=5>>=
    ...
    par(mfrow=c(1,2))
      Z1 <- raibp(N=5,a=2)
      a.image(Z1,main="Figure 1: IBP(N=50, a=2)",cex.main=.8,axis.num=F,color=c("gray100","gray30"))
      ...
      Z2 <- raibp(N=5,a=5)
      a.image(Z2,main="Figure 2: IBP(N=50, a=5)",cex.main=.8,axis.num=F,col=c("gray100","gray30"))
  ...
  \frame{
    ...
    \begin{multline*}
      P(\bm{Z|D},\alpha) = 
        ...
        \prodl{i}{2}{N} p_{i,k}^{z_{i,k}} (1-p_{i,k})^{1-z_{i,k}}
...
<<fig=T,echo=F,height=5>>=
    ...
    par(mfrow=c(1,3))
      ...
      a.image(Z1,main="Figure 1: AIBP(N=5, a=2, D)",cex.main=.8,axis.num=F,color=c("gray100","gray30"))
      axis(2,at=seq(1,0,len=nrow(DD)),label=paste("Cust",1:nrow(DD)),las=2)
      axis(1,at=seq(0,1,len=ncol(Z1)),label=paste("Col",1:ncol(Z1)),las=2)
      Z2 <- raibp(N=nrow(DD),D=DD,a=5)
      a.image(Z2,main="Figure 1: AIBP(N=5, a=5, D)",cex.main=.8,axis.num=F,color=c("gray100","gray30"))
      axis(2,at=seq(1,0,len=nrow(DD)),label=paste("Cust",1:nrow(DD)),las=2)
      axis(1,at=seq(0,1,len=ncol(Z2)),label=paste("Col",1:ncol(Z2)),las=2)
    par(mfrow=c(1,1))
@
